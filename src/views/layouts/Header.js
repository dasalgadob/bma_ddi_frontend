...
render(){
    ...
    <div className="navbar-collapse collapse  dual-collapse2">
        <ul className="navbar-nav mr-auto">
            ...
            <li className="nav-item">
            <NavLink to="/renewalsList" className="nav-link" activeClassName="active">{t('renewals.title')}</NavLink>
            </li>
    ...
    <div className="navbar-collapse collapse  dual-collapse2">
        ...
        <li className="nav-item dropdown" style={dropdownStyle}>
            ...
            <div className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            <NavLink to="/users"  className="dropdown-item">{t('settings.title')}</NavLink>
